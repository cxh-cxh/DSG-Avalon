class ActionDescriptions:
    def __init__(self, race):
        ...
        self.empty_action_id = self.action_dict_len - 1  
    ...
    def get_action_description(self, action_id):
        """
        Returns the action description based on the action id
        :param action_id:
        :return:
        """
    ...
    def get_action_code(self, action_description):
        """
        Returns the action id based on the action description
        ...
        for action_code, description in self.action_descriptions.items():
            if description == action_description:
                return action_code
        raise ValueError(f"Not found with description '{action_description}' crresponding action code.")
