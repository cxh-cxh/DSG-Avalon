...
from games.stratego.game import socket_pickle
from games.stratego.game.config import STANDARD_STRATEGO_CONFIG, BARRAGE_STRATEGO_CONFIG, MEDIUM_STRATEGO_CONFIG, \
...
from games.stratego.game.enums import ObservationModes, ObservationComponents, GameVersions
from games.stratego.game.stratego_procedural_env import StrategoProceduralEnv
from games.stratego.game.stratego_procedural_impl import RecentMoves, SP, \
...
from games.stratego.game.util import get_random_initial_state_fn, get_random_human_init_fn, get_random_curriculum_init_fn
...
class StrategoMultiAgentEnv:
    ...
    def __init__(self,args):
        ...
        self.args=args
        if args.game.game_mode == 'agent_vs_human':
            env_config = {
                'version': GameVersions.STANDARD,
                'random_player_assignment': False,
                'human_inits': True,
        ...
        elif args.game.game_mode == 'agent_vs_agent':
            env_config = {
                'version': GameVersions.STANDARD,
                'random_player_assignment': False,
                'human_inits': True,
            ...
            raise Exception("game.vs_human value is wrong, please check!")
        ...
        if self.vs_human:
            from games.stratego.game.stratego_human_server import StrategoHumanGUIServer
        ...
        self.logger.info("="*5+f"StrategoMultiAgentEnv Init Successfully!: "+"=" * 5)
    ...
    def reset(self, first_player_override=None, initial_state_override=None):
        ...
        if self.use_curriculum_inits:
            initial_state, likely_winner = self.random_initial_state_fn(self.args.game.game_init)
            ...
            if self.repeat_games_from_other_side and self.episodes_completed % 2 == 1:
                ...
                initial_state = self.random_initial_state_fn(self.args.game.game_init)
                self.player = 1
