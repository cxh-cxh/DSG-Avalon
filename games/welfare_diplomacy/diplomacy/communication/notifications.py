...
from games.welfare_diplomacy.diplomacy.utils import common, exceptions, parsing, strings
from games.welfare_diplomacy.diplomacy.utils.network_data import NetworkData
