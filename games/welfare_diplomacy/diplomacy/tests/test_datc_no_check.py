...
from games.welfare_diplomacy.diplomacy.tests.test_datc import TestDATC as RootDATC
from games.welfare_diplomacy.diplomacy.utils.order_results import OK, VOID
