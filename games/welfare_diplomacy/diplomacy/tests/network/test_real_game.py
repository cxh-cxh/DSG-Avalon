...
from games.welfare_diplomacy.diplomacy.server.server import Server
...
from games.welfare_diplomacy.diplomacy.engine.message import GLOBAL, Message as EngineMessage
