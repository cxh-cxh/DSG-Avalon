...
# ==============================================================================
""" Run tests from games.welfare_diplomacy.diplomacy.tests.network.test_real_game to test games in a real environment.
...
from games.welfare_diplomacy.diplomacy.tests.network import test_real_game
